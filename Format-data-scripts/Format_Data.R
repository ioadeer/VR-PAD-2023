...
# bloque 2 = SALA_CHICA
# bloque 3 = SALA_PARLANTES (para todos)
my_path = "analisis-pad-2-salas-vacias/data/33_50_s/raw/csv/"
...
write.table(all_data, file="analisis-pad-2-salas-vacias/data/33_50_s/data-s33-50.csv", row.names = FALSE)

all_data.first_block <- all_data %>%
  filter(nbloque == 1)

write.table(all_data.first_block, file="analisis-pad-2-salas-vacias/data/33_50_s/data-s33-50-1-block.csv", row.names = FALSE)
