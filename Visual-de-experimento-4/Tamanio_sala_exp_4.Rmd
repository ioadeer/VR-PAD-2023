...
dimensions.volume_aggr$variable = factor(dimensions.volume_aggr$variable, levels=c("No visual information",
                                                                                   "Virtual environment",
                                                                                   "Real environment"))
...
violin_depth <- ggplot(dimensions.depth, aes(x=Condition, y=Depth,  fill=Condition)) +
  ...
  #geom_errorbar(dimensions.depth_sum, aes(ymin=mean - se,
  #        ymax=mean + se),
  #        color = "#22292F",
  #        width = .1) +
