---
title: "ADP - Experiment 1"
format: html
editor: visual
---

## ADP analisis of Experiment 1 Cervino et al. 2025
...
-   Logarithm of percieved distance as dependent variable
...
#### Logarithmic signed bias (precision)
```{r Signed bias LMEM}
#| message: false
#| warning: false
...
tab_model(m.logSignedBias, file ="./stats/logsignedbias_model.html")
```
##### Anova
...
##### Logarithmic signed bias Variability
...
tab_model(m.logSignedBiasVar, file ="./stats/logsignedbias_var_model.html")
```
###### Anova 
...
write_csv(anovlogSBVar, file = "./stats/logsignedbias_var_anova.csv")
...
tab_model(m.logUnsignedBias, file ="./stats/logUnsignedbias_model.html")
```
##### ANOVA 
...
write_csv(anovlogUB, file="./stats/logunsigned_bias_anova.csv")
...
write_csv(effect_sizeUB, file="./stats/logunsigned_bias_effect_size.csv")
