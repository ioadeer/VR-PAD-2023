...
write.table(tabla.volumen, file="./analisis-pad-main/data/dimensiones_de_sala_visual_1_32_sin_outliers.csv", row.names = FALSE)



# load data ---------------------------------------------------------------

tabla.dimensions <- read.csv('./analisis-pad-main/data/dimensiones_de_sala_visual_1_32_sin_outliers.csv', header = TRUE, sep = ' ', stringsAsFactors = TRUE)
...
write.table(tabla.analisis_correlacion, file="./analisis-pad-main/data/analisis_correlacion_1_32.csv", row.names = FALSE)

# analisis de correlacion usando bloque 1 ---------------------------------

tabla.analisis_cor <- read.csv("./analisis-pad-main/data/analisis_correlacion_1_32.csv", header = TRUE, sep = ' ', stringsAsFactors = TRUE)
