...
anov1 <- anova(m.Dist1)
anov1
#write.csv(anov1, file="./Experiment_4/Exp_4_ADP_vr/stats/model_anova.csv")
effect_size = eta_squared(anov1)
#write.csv(effect_size, file="./Experiment_4/Exp_4_ADP_vr/stats/model_eta_squared.csv")
...
# para imprimir
#tab_model(m.Dist1, file ="./Experiment_4/Exp_4_ADP_vr/stats/model.html")
...
f1 <- ggplot(tabla.pob, aes(x=target_distance, y =10^Mperc_dist, group = room_condition, color  = room_condition)) +
  ...
  scale_color_manual(labels = c("NVI", "LVE"), values =c(myViridis[1], myViridis[2]))+
...
#write_csv(anovlogSB, file ="./Experiment_4/Exp_4_ADP_vr/stats/logSignedBias_anova.csv")
#tab_model(m.logSignedBias, file ="./Experiment_4/Exp_4_ADP_vr/stats/logSignedBias_model.html")
...
#write_csv(anovlogSBVar, file ="./Experiment_4/Exp_4_ADP_vr/stats/logSignedBiasVar_anova.csv")
#tab_model(m.logSignedBiasVar, file ="./Experiment_4/Exp_4_ADP_vr/stats/logSignedBiasVar_model.html")
effect_sizeSBVar = eta_squared(anovlogSBVar)
write_csv(effect_sizeSBVar, file ="./Experiment_4/Exp_4_ADP_vr/stats/logSignedBiasVar_effectsize.csv")
...
#write_csv(anovlogUB, file ="./Experiment_4/Exp_4_ADP_vr/stats/logUnsignedBias_anova.csv")
#tab_model(m.logUnsignedBias, file ="./Experiment_4/Exp_4_ADP_vr/stats/logUnsignedBiasVar_model.html")
effect_sizeUB = eta_squared(anovlogUB)
#write_csv(effect_sizeUB, file ="./Experiment_4/Exp_4_ADP_vr/stats/logUnsignedBias_effectsize.csv")
