...
rm(list=ls())
tabla.raw <- read.csv('./Experiment_4/Exp_4_ADP_vr/data/1_16_NVI_LVE.csv', header = TRUE, sep = ' ', stringsAsFactors = TRUE)
...
# descomentar para escirbir nuevos dataset (primerop sacar outliers)
 write_csv("./Experiment_4/Exp_4_ADP_vr/ResultsData/results_log_bias.csv")
