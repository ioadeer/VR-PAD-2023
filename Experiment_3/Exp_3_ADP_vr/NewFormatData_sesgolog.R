...
rm(list=ls())
tabla.raw <- read.csv('./Experiment_3/Exp_3_ADP_vr/data/1_20_oscuras_vr.csv', header = TRUE, sep = ' ', stringsAsFactors = TRUE)
...
# descomentar para escirbir nuevos dataset (primerop sacar outliers)
 write_csv("./Experiment_3/Exp_3_ADP_vr/ResultsData/results_log_bias.csv")
