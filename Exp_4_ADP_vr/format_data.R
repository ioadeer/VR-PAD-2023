# Ojo que en este experimento usamos una entorno virtual mas grande que el real
...
my_path = "Exp_4_ADP_vr/data/raw/csv/"
...
for (file_name in list.files(path = my_path)) {
  ...
  print(num2)
  if (num2 == 1) {
    data$condicion_sala = "No Visual Info"
  } else if (num2 == 2) {
    data$condicion_sala = "Larger VE"
  }
