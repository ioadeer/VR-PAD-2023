...
#tab_model(lm.depth, file ="stats/Exp_3/depth/depth-lm.html")

anova.depth <- anova(lm.depth)

#write.csv(anova.depth, file="stats/Exp_3/depth/anova.csv")
...
#write.csv(t_test_depth.tidy, file="stats/Exp_3/width/width-t-test.csv")

lm.width <- lm(Width ~ Condition, 
                    data = dimensions.width)

#tab_model(lm.width, file ="stats/Exp_3/width/width-lm.html")

anova.width <- anova(lm.width)

#write.csv(anova.width, file="stats/Exp_3/width/anova.csv")
...
#write.csv(t_test_height.tidy, file="stats/Exp_3/height/height-t-test.csv")

lm.height <- lm(Height ~ Condition, 
                    data = dimensions.height)

#tab_model(lm.height, file ="stats/Exp_3/height/height-lm.html")

anova.height <- anova(lm.height)

#write.csv(anova.height, file="stats/Exp_3/height/anova.csv")
...
dimensions.volume
#write.csv(dimensions.volume, file="stats/Exp_3/volume/volume_all.csv")
...
#write.csv(vol.t_test.tidy, file="stats/Exp_3/volume/volume-t-test.csv")

dim_barchart <- dimensions.volume %>%
  ggplot(aes(Condition, mean)) +
  geom_col(aes(fill = Condition), color ="black", width =0.85) +
  scale_x_discrete(labels = c('No visual info','VE'))+
...
mi_nombre_de_archivo = paste(figures_folder, .Platform$file.sep, "Perceived_room_OSCURAS_VIRTUAL_V2.png", sep = '')
