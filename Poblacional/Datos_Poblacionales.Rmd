...
Participaron un total de `r count(tabla.all)` participantes de los tres experimentos.
...
Participaron un total de `r count(tabla.primer_exp)` participantes del primer experimento.
...
Participaron un total de `r count(tabla.segundo_exp)` participantes de segundo experimento.
...
Participaron un total de `r count(tabla.tercer_exp)` participantes del tercer experimento.
