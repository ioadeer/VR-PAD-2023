...
#### Subestimación de entornos

- 54% para el entorno real
- 56% para el entorno virtual

El resultado de la
subestimación coincide con lo reportado en (@kelly_perceived_2017),
donde se realiza un experimento con un casco
similar (HTC Vive)
...
Similar estimación de tamaño para ambos entornos, deifiere a 
lo reportado en literatura (@knapp_limited_2004)
