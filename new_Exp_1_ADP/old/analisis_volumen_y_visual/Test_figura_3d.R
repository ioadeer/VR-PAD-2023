# Borrado para grafico 3d de volumen de sala percibido
# NOTA
# eliminar gente que haya reportado mas de 1000 m3 de volumen
...
plt <- subplot(fig1, fig2) # no layout specified
